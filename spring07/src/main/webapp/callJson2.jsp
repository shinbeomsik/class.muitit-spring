		...
		$('#b2').click(function() {
			$.ajax({
				...
				success: function(json) {
					id1 = json[1].id
					name1 = json[1].name
					$('#result').append("json 배열중 2번째 것 >> " + name1 + " " + id1 + "<br>")
...
<body>
<button id="b1" class="btn btn-outline-primary">컨트롤러에서 JSON(텍스트)을 받아오자.!</button>
<button id="b11" class="btn btn-outline-secondary">컨트롤러에서 JSON(다른모양,table,li)을 받아오자.!</button>
<button id="b111"  class="btn btn-outline-success">컨트롤러에서 JSON(다른모양,table,li)을 받아오자.!</button>
<button id="b2"  class="btn btn-outline-info">컨트롤러에서 JSONArray를 받아오자.!</button>
<hr color="bule">
